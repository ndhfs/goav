...
func SwsGetcontext(sw, sh uint, sf avutil.PixelFormat, dw, dh uint, df avutil.PixelFormat, f int, sfl, dfl *Filter, p *int) *Context {
...
func SwsGetcachedcontext(ctxt *Context, sw, sh uint, sf avutil.PixelFormat, dw, dh uint, df avutil.PixelFormat, f int, sfl, dfl *Filter, p *float64) *Context {
